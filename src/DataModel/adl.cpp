...
bool ADL::Init()
{
    ...
    GetFunc(ADL_Overdrive6_Capabilities_Get, ADL_OVERDRIVE6_CAPABILITIES_GET)
    GetFunc(ADL_Overdrive6_CurrentStatus_Get, ADL_OVERDRIVE6_CURRENTSTATUS_GET)
    GetFunc(ADL_Overdrive6_Temperature_Get, ADL_OVERDRIVE6_TEMPERATURE_GET)
    GetFunc(ADL_Overdrive6_FanSpeed_Get, ADL_OVERDRIVE6_FANSPEED_GET)
